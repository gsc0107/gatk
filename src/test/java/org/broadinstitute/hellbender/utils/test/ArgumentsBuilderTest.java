...
public final class ArgumentsBuilderTest{
    ...
    public void testFromArray(){
        final ArgumentsBuilder args = new ArgumentsBuilder(new Object[]{"Option=" + new File("path/to"), "OtherOption=" + -1, new File("somewhere")});
    ...
    public void testAddFileArgument() throws Exception {
        final ArgumentsBuilder args = new ArgumentsBuilder();
        final File file = new File("path/to/somewhere");
