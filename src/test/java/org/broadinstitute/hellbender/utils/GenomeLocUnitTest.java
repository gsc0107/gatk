...
public final class GenomeLocUnitTest extends BaseTest {
    ...
    public void testIsBetween() {
        final GenomeLoc locMiddle = hg19GenomeLocParser.createGenomeLoc("1", 3, 3);

        final GenomeLoc locLeft = hg19GenomeLocParser.createGenomeLoc("1", 1, 1);
        final GenomeLoc locRight = hg19GenomeLocParser.createGenomeLoc("1", 5, 5);
    ...
    public void testContigIndex() {
        final GenomeLoc locOne = hg19GenomeLocParser.createGenomeLoc("1",1,1);
        Assert.assertEquals(0, locOne.getContigIndex());
        Assert.assertEquals("1", locOne.getContig());

        final GenomeLoc locFour = hg19GenomeLocParser.createGenomeLoc("4",1,1);
        Assert.assertEquals(3, locFour.getContigIndex());
        Assert.assertEquals("4", locFour.contigName);

        final GenomeLoc locNumber = hg19GenomeLocParser.createGenomeLoc(hg19Header.getSequenceDictionary().getSequence(0).getSequenceName(), 1, 1);
    ...
    public void testCompareTo() {
        final GenomeLoc twoOne = hg19GenomeLocParser.createGenomeLoc("2", 1);
        final GenomeLoc twoFive = hg19GenomeLocParser.createGenomeLoc("2", 5);
        final GenomeLoc twoOtherFive = hg19GenomeLocParser.createGenomeLoc("2", 5);
        ...
        final GenomeLoc oneOne = hg19GenomeLocParser.createGenomeLoc("1", 5);
    ...
    public void testEndpointSpanUnmapped() throws Exception {
        final GenomeLoc twoOne = hg19GenomeLocParser.createGenomeLoc("2", 1);
        final GenomeLoc unmapped = GenomeLoc.UNMAPPED;
    ...
    public void testEndpointWrongContig() throws Exception {
        final GenomeLoc twoOne = hg19GenomeLocParser.createGenomeLoc("2", 1);
        final GenomeLoc threeFive = hg19GenomeLocParser.createGenomeLoc("3", 5);
        twoOne.endpointSpan(threeFive);
    }

    @Test
    public void testUnmappedSort() {
        final GenomeLoc chr1 = hg19GenomeLocParser.createGenomeLoc("1",1,10000000);
        final GenomeLoc chr2 = hg19GenomeLocParser.createGenomeLoc("2",1,10000000);
        final GenomeLoc unmapped = GenomeLoc.UNMAPPED;

        final List<GenomeLoc> unmappedOnly = Arrays.asList(unmapped);
        ...
        final List<GenomeLoc> chr1Presorted = Arrays.asList(chr1,unmapped);
        ...
        final List<GenomeLoc> chr1Inverted = Arrays.asList(unmapped,chr1);
        ...
        final List<GenomeLoc> chr1and2Presorted = Arrays.asList(chr1,chr2,unmapped);
        ...
        final List<GenomeLoc> chr1and2UnmappedInFront = Arrays.asList(unmapped,chr1,chr2);
        ...
        final List<GenomeLoc> chr1and2UnmappedSandwiched = Arrays.asList(chr1,unmapped,chr2);
    ...
    private final class ReciprocalOverlapProvider extends TestDataProvider {
        ...
        private ReciprocalOverlapProvider(final int start1, final int stop1, final int start2, final int stop2) {
    ...
    public void testReciprocalOverlapProvider(final ReciprocalOverlapProvider cfg) {
    ...
    public void testGenomeLocComparisons(final GenomeLoc g1, final GenomeLoc g2, final ComparisonResult expected) {
    ...
    private final class MergeTest {
        public final List<GenomeLoc> locs;
    ...
    public void testSimpleGenomeLoc(final MergeTest test) {
        testMerge(test.locs);
    }
    ...
    private void testMerge(final List<GenomeLoc> locs) {
        ...
        final GenomeLoc result2 = GenomeLoc.merge(new TreeSet<>(locs));
    ...
    public void testDistanceAcrossContigs() {
        ...
        final SAMFileHeader header = ArtificialReadUtils.createArtificialSamHeader(10, 0, chrSize);
        final GenomeLocParser parser = new GenomeLocParser(header.getSequenceDictionary());
        final GenomeLoc loc1 = parser.createGenomeLoc("3", 500);  // to check regular case
        final GenomeLoc loc2 = parser.createGenomeLoc("7", 200);  // to check regular case
        final GenomeLoc loc3 = parser.createGenomeLoc("0", 1);    // to check corner case
        final GenomeLoc loc4 = parser.createGenomeLoc("9", 1000);// to check corner case
        final GenomeLoc loc5 = parser.createGenomeLoc("7", 500);  // to make sure it does the right thing when in the same chromosome

        final GenomeLoc loc6 = parser.createGenomeLoc("7", 200, 300);
        final GenomeLoc loc7 = parser.createGenomeLoc("7", 500, 600);
        final GenomeLoc loc8 = parser.createGenomeLoc("9", 500, 600);
