...
public class VariantRecalibrator extends MultiVariantWalker {
    ...
    @Argument(fullName="aggregate",
            ...
            optional=true)
    private final List<FeatureInput<VariantContext>> aggregate = new ArrayList<>();
    ...
    @Argument(fullName="resource",
            ...
            optional=false)
    private final List<FeatureInput<VariantContext>> resource = new ArrayList<>();
    ...
    @Argument(fullName="target_titv",
            ...
            optional=true)
    private final double TARGET_TITV = 2.15;
    ...
    @Argument(fullName="use_annotation",
            ...
            optional=false)
    private final List<String> USE_ANNOTATIONS = new ArrayList<>();
    ...
    @Argument(fullName="TStranche",
            ...
            optional=true)
    private final List<Double> TS_TRANCHES = new ArrayList<Double>(Arrays.asList(100.0, 99.9, 99.0, 90.0));
    ...
    private final String RSCRIPT_FILE = null;
    ...
    @Argument(fullName="replicate",
            ...
            optional=true)
    private final int REPLICATE = 200;
    ...
    @Argument(fullName="max_attempts",
            ...
            optional=true)
    @VisibleForTesting
    protected final int max_attempts = 1;
    ...
    @Argument(fullName = "trustAllPolymorphic",
            ...
            optional=true)
    private final boolean TRUST_ALL_POLYMORPHIC = false;
    ...
    @Argument(fullName="gatk3Compatibility", shortName="gatk3",
            ...
            optional=true)
    private final boolean gatk3Compatibility = false;
    ...
    private final ArrayList<Double> replicate = new ArrayList<>(REPLICATE * 2);
    private final Set<String> ignoreInputFilterSet = new TreeSet<>();
    private final VariantRecalibratorEngine engine = new VariantRecalibratorEngine( VRAC );
    private final ExpandingArrayList<VariantDatum> reduceSum = new ExpandingArrayList<>(2000);
    private final List<ImmutablePair<VariantContext, FeatureContext>> variantsAtLocus = new ArrayList<>();
    ...
    protected GATKReportTable makeVectorTable(
        ...
        final GATKReportTable vectorTable = new GATKReportTable(
