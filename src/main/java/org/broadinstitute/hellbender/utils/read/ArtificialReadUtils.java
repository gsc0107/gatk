...
public final class ArtificialReadUtils {
     ...
     * @return
     */
    public static SAMFileHeader createArtificialSamHeader(final int numberOfChromosomes, final int startingChromosome, final int chromosomeSize) {
        ...
        for (int x = startingChromosome; x < startingChromosome + numberOfChromosomes; x++) {
            final SAMSequenceRecord rec = new SAMSequenceRecord( Integer.toString(x), chromosomeSize /* size */);
     ...
     */
    public static SAMFileHeader createArtificialSamHeaderWithGroups(final int numberOfChromosomes, final int startingChromosome, final int chromosomeSize, final int groupCount) {
        ...
        for (int i = 0; i < groupCount; i++) {
            final SAMReadGroupRecord rec = new SAMReadGroupRecord(DEFAULT_READ_GROUP_PREFIX + i);
     ...
     */
    public static GATKRead createArtificialRead(final SAMFileHeader header, final String name, final int refIndex, final int alignmentStart, final int length) {
     ...
     * @return the artificial GATKRead
     */
    public static GATKRead createArtificialRead(final SAMFileHeader header, final String name, final int refIndex, final int alignmentStart, final byte[] bases, final byte[] qual) {
     ...
     * @return the artificial GATKRead
     */
    public static GATKRead createArtificialRead(final SAMFileHeader header, final String name, final String contig, final int alignmentStart, final byte[] bases, final byte[] qual) {
     ...
     * @return the artificial GATKRead
     */
    public static GATKRead createArtificialRead(final SAMFileHeader header, final String name, final int refIndex, final int alignmentStart, final byte[] bases, final byte[] qual, final String cigar) {
     ...
     * @return the artificial GATKRead
     */
    public static GATKRead createArtificialRead(final SAMFileHeader header, final String name, final String contig, final int alignmentStart, final byte[] bases, final byte[] qual, final String cigar) {
    ...
    public static GATKRead createHeaderlessSamBackedRead( final String name, final String contig, final int start, final int length ) {
        final GATKRead read = createSamBackedRead(name, contig, start, length);
     ...
     */
    public static SAMRecord createArtificialSAMRecord(final SAMFileHeader header, final String name, final int refIndex, final int alignmentStart, final int length) {
     ...
     * @return the artificial SAMRecord
     */
    public static SAMRecord createArtificialSAMRecord(final SAMFileHeader header, final String name, final int refIndex, final int alignmentStart, final byte[] bases, final byte[] qual) {
        ...
        final SAMRecord rec = createArtificialSAMRecord(header, name, refIndex, alignmentStart, bases.length);
     ...
     * @return the artificial SAMRecord
     */
    public static SAMRecord createArtificialSAMRecord(final SAMFileHeader header, final String name, final int refIndex, final int alignmentStart, final byte[] bases, final byte[] qual, final String cigar) {
        final SAMRecord rec = createArtificialSAMRecord(header, name, refIndex, alignmentStart, bases, qual);
    ...
    public static Read createArtificialGoogleGenomicsRead( final String name, final String contig, final int start, final byte[] bases, final byte[] quals, final String cigar ) {
        final Read googleRead = new Read();
        ...
        final List<Integer> convertedQuals = new ArrayList<>();
    ...
    public static List<GATKRead> createPair(final SAMFileHeader header, final String name, final int readLen, final int leftStart, final int rightStart, final boolean leftIsFirst, final boolean leftIsNegative) {
        final GATKRead left = createArtificialRead(header, name, 0, leftStart, readLen);
        final GATKRead right = createArtificialRead(header, name, 0, rightStart, readLen);
        ...
        final int isize = rightStart + readLen - leftStart;
    ...
    public static GATKRead createRandomRead(final SAMFileHeader header, final int length) {
    ...
    public static GATKRead createRandomRead(final int length) {
        final SAMFileHeader header = createArtificialSamHeader();
        return createRandomRead(header, length);
    }

    public static GATKRead createRandomRead(final SAMFileHeader header, final int length, final boolean allowNs) {
        final byte[] quals = createRandomReadQuals(length);
        final byte[] bbases = createRandomReadBases(length, allowNs);
        return createArtificialRead(bbases, quals, bbases.length + "M");
    }

    public static GATKRead createRandomRead(final int length, final boolean allowNs) {
        final SAMFileHeader header = createArtificialSamHeader();
     ...
     */
    public static byte[] createRandomReadQuals(final int length) {
     ...
     */
    public static byte[] createRandomReadBases(final int length, final boolean allowNs) {
        final Random random = Utils.getRandomGenerator();
        final int numberOfBases = allowNs ? 5 : 4;
     ...
     */
    public static ArtificialReadQueryIterator mappedReadIterator(final int startingChr, final int endingChr, final int readCount) {
        final SAMFileHeader header = createArtificialSamHeader((endingChr - startingChr) + 1, startingChr, readCount + DEFAULT_READ_LENGTH);
     ...
     * @return iterator representing the specified amount of fake data
     */
    public static ArtificialReadQueryIterator mappedAndUnmappedReadIterator(final int startingChr, final int endingChr, final int readCount, final int unmappedReadCount) {
        final SAMFileHeader header = createArtificialSamHeader((endingChr - startingChr) + 1, startingChr, readCount + DEFAULT_READ_LENGTH);
