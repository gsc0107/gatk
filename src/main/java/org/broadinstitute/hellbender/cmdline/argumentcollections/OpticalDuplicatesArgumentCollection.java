...
public final class OpticalDuplicatesArgumentCollection implements ArgumentCollectionDefinition {
    ...
    @Argument(doc = "Regular expression that can be used to parse read names in the incoming SAM file. Read names are " +
             ...
             optional = true)
    public final String READ_NAME_REGEX = OpticalDuplicateFinder.DEFAULT_READ_NAME_REGEX;
    ...
    @Argument(doc = "The maximum offset between two duplicate clusters in order to consider them optical duplicates. This " +
        ...
        "Illumina pipeline that multiply pixel values by 10, in which case 50-100 is more normal.",
              optional = true)
    public final int OPTICAL_DUPLICATE_PIXEL_DISTANCE = OpticalDuplicateFinder.DEFAULT_OPTICAL_DUPLICATE_DISTANCE;
}
